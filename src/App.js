...
function App() {
  ...
  return (
   ...
   <Navbar/>
      ...
      {/* About Section */}
      <div id='about-me'><br/><br/></div>
      <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <h1>About Me</h1>
        <p>I graduated Sacramento State in May 2024, with a Bachelors of Science in Computer Science.<br/>
          I am actively looking for job opportunites.
        </p>
      </section>
      ...
      <h1>Projects</h1>
      <CardSlider/>
      <h2><span className='highlight'>Dragon Minutes</span></h2>
      <img src={dragonLogo} alt="Dragon Project" className="project-image" />
      <p>Dragon Minutes was my senior project at Sacramento State.</p>
      </section>
      ...
      <h2>Languages</h2>
        <ul>
          <li><box-icon name='java' type='logo' ></box-icon>Java</li>
          <li><box-icon type='logo' name='javascript'></box-icon>JavaScript</li>
          <li><box-icon name='file-css' type='solid' ></box-icon>CSS</li>
          <li><box-icon name='file-html' type='solid' ></box-icon>HTML</li>
          <li><box-icon name='react' type='logo' ></box-icon>React</li>
        </ul>
        </div>
        ...
        <h2>Tools</h2>
        <ul>
          <li><box-icon name='github' type='logo' ></box-icon>Git</li>
          <li><svg className='jira-svg' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 22 21.902">
        ...
        <h2>Databases</h2>
        <ul>
          <li><svg className='mysql-svg' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 24 24">
          ...
          <li><img width="28" height="28" src="https://img.icons8.com/external-bearicons-detailed-outline-bearicons/64/external-SQL-file-extension-bearicons-detailed-outline-bearicons.png" alt="external-SQL-file-extension-bearicons-detailed-outline-bearicons"/>SQL</li>
        </ul>
        </div>
      ...
      {/* Hobbies Section */}
      <div id='hobbies'><br/><br/></div>
      <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
      <h1>Hobbies and Interests</h1>
      <h2>Fishing</h2>
      <p>   
        I love to go fishing in when I have spare time.<br/>
      </p>
      <h2>Music</h2>
      <p>   
        Being introduced to Hip-Hop in my early stages of life allowed me <br/>
        to create a sort of passion for the genre.  My favorite artists include<br/>
        IDK, Nas, Kendrick Lamar, and 50 Cent.<br/>
      </p>
      <h2>Video Games</h2>

      <h2>Fitness</h2>
      <p>   
        One of the biggest accomplishments I think I have done is losing 55 pounds.<br/>
        It was one of the hardest things I had to do but through determination and <br/>
        discpline I was able to restrain my self from eating so much and get myself<br/>
      ...
      {/* Contact Me */}
      <div id='contact-me'><br/><br/></div>
      <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <h1>Contact Me</h1>
        <Contactform/>
        <p className='contact-links'><a href="https://linkedin.com/in/angelojaydelacruz" target="_blank" rel="noreferrer"><box-icon name='linkedin-square' type='logo' ></box-icon>AngeloJayDelaCruz</a></p>
        <p className='contact-links'><a href="https://github.com/AngeloJay" target="_blank" rel="noreferrer"><box-icon type='logo' name='github'></box-icon>AngeloJay</a></p>
        <p className='contact-links'><a href='mailto:angelo.jay@outlook.com' target="_blank" rel="noreferrer"><box-icon type='solid' name='envelope'></box-icon>angelo.jay@outlook.com</a></p>
      </section>
