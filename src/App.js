  ...
  return (
    <div className="main">
      ...
      <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <h1>About Me</h1>
        <p>
          I graduated Sacramento State in May 2024, with a Bachelors of Science
          in Computer Science.
          <br />I am actively looking for job opportunites.
        </p>
      </section>
      ...
      <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        ...
        <CardSlider />
        <h2>
          <span className="highlight">Dragon Minutes</span>
        </h2>
